...
class DesertScene: public cocos2d::CCLayerColor 
{
public:
...
private:
	...
	void MonsterFactory(std::vector<CCSprite*> &monster);
	...
	void switch_flipX(CCNode *pSender);
	void _switch_flipX(CCNode *pSender);
